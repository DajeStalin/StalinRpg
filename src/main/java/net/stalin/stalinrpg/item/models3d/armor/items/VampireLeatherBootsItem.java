...
public class VampireLeatherBootsItem extends GeoArmorItem implements IAnimatable {
    public AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public VampireLeatherBootsItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList
                .containsAll(Collections.singletonList(ItemRegistry3DArmor.VAMPIRE_LEATHER_BOOTS.get()));
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<VampireLeatherBootsItem>(this, "controller", 20, this::predicate));
    }
