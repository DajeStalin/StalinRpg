...
public class VampireLeatherHeadItem extends GeoArmorItem implements IAnimatable {
    public AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public VampireLeatherHeadItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList
                .containsAll(Collections.singletonList(ItemRegistry3DArmor.VAMPIRE_LEATHER_HEAD.get()));
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<VampireLeatherHeadItem>(this, "controller", 20, this::predicate));
    }
