...
public class RogueClassGui extends Screen {

    public RogueClassGui(ITextComponent p_i51108_1_) {
        super(p_i51108_1_);
    }

    Button button_next, button_pre, button_select;

    ResourceLocation SELECT_CLASS = new ResourceLocation(StalinRpg.MOD_ID, "textures/gui/menu/screens/rogue_screen.png");
